...
void novoNoh (noh *inicio, char *conteudoString){ // recebe 
	...
	nohEmCriacao->conteudoString = (char*)malloc(strlen(conteudoString)); // precisa declarar o espaco de memoria pra string separada ja que varia
	strcpy(nohEmCriacao->conteudoString, conteudoString); //copia o conteudo da string pra dentro do espaco conteudoString na struct
